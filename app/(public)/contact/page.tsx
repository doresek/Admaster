          ...
          <form onSubmit={submit} className="space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input value={form.name} onChange={e => setForm(f => ({...f, name: e.target.value}))} required
                  className="w-full bg-[#1A2A42] border border-[#243752] rounded-lg px-3 py-2.5 text-sm text-white focus:border-[#0A7AFF] focus:outline-none" />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea value={form.message} onChange={e => setForm(f => ({...f, message: e.target.value}))} required rows={6}
                className="w-full bg-[#1A2A42] border border-[#243752] rounded-lg px-3 py-2.5 text-sm text-white focus:border-[#0A7AFF] focus:outline-none resize-y" />
            </div>
