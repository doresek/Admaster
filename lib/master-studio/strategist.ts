...
═══ SCROLL-STOP (🛑 האווטאר מזין את עצירת-הגלילה) ═══
היוצר יבנה בהמשך תמונה והוק שחייבים לעצור פיזית את האגולל של הקהל הזה בחצי-השנייה הראשונה. לכן חדד את fears ו-desires להיות ויסצרליים, ספציפיים ומוחשיים (הכאב האמיתי / התשוקה / החלום של הקהל) — לא תיאורים כלליים. ככל שהם חדים יותר, כך אפשר לגזור מהם ויזואל עוצר-גלילה במקום סצנת סטוק גנרית. השאר בדיוק את המפתחות למטה.
