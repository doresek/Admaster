...
═══ מקור האמת (חובה — אל תפר) ═══
התבסס אך ורק על המידע שסופק: ה-CLIENT BRIEF וה-BRAND DNA שלמעלה (אם הופיעו) והבריף שלמטה. זהו מקור האמת היחיד.
אסור להמציא עובדות שלא נמסרו: מוצרים, מחירים, אחוזי הנחה, שמות, מספרים, סטטיסטיקות, אחריות, מיקום, תאריכים או הטבות.
מותר לעצב, לרגש ולספר — אבל כל פרט עובדתי בפוסט חייב להגיע מהבריף/לקוח. אם פרט חסר — הישאר כללי או השמט אותו, אל תמציא אותו.
